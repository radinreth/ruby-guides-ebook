...
a class `Book`, you should have a database table called . The Rails
...
+ - These fields should be named following the pattern
`singularized_table_name_id` (e.g., `item_id`, `order_id`). These are the
fields that Active Record will look for when you create associations between
your models.
+ - By default, Active Record will use an integer column named
...
CRUD is an acronym for the four verbs we use to operate on data: reate,
ead, pdate and elete. Active Record automatically creates methods
